<?php
// Script pour corriger les anciennes images (sans vérification de session)
require_once 'backend/db.php';

echo "<h2>Correction des anciennes images</h2>";
echo "<p><strong>ATTENTION :</strong> Ce script fonctionne sans vérification de session. Utilisez-le uniquement si vous êtes l'administrateur du site.</p>";
