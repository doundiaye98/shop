<?php
// Script pour ajouter des produits dans la catégorie Garçon
require_once 'backend/db.php';

echo "<h2>👕 Ajout de produits dans la catégorie Garçon</h2>";
...
try {
    ...
    if (isset($_POST['confirm']) && $_POST['confirm'] === 'yes') {
        ...
        echo "<ul>";
        echo "<li>Vérifiez que les produits s'affichent correctement sur votre site</li>";
        echo "<li>Testez l'ajout au panier pour ces nouveaux produits</li>";
        echo "<li>Vérifiez que les images s'affichent bien</li>";
        echo "</ul>";
        ...
        echo "<p>Ce script va ajouter " . count($products) . " nouveaux produits dans la catégorie Garçon.</p>";
        echo "<p><strong>Voulez-vous procéder à l'ajout ?</strong></p>";
        ...
        echo "✅ Confirmer l'ajout de " . count($products) . " produit(s)";
        echo "</button></p>";
        echo "</form>";
