...
<body>
    ...
    <script>
    fetch('backend/products.php?category=Bébé')
        .then(res => res.json())
        .then(products => {
            const container = document.getElementById('products-container');
            if (!products.length) {
                container.innerHTML = '<div class="text-center text-muted">Aucun produit bébé à afficher.</div>';
                return;
            }
