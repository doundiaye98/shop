...
<body>
    ...
    <script>
    fetch('backend/products.php?promo=true')
        .then(res => res.json())
        .then(products => {
            const container = document.getElementById('products-container');
            if (!products.length) {
                container.innerHTML = '<div class="text-center text-muted">Aucune promotion à afficher.</div>';
                return;
            }
                ...
                <div class="product-card">
                    ...
                    <div class="product-info">
                        ...
                        <div class="product-price">
                            ...
                            <span class="price-new">${prod.promo_price} €</span>
                        </div>
